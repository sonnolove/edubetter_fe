...
class _SubjectsTabState extends State<SubjectsTab> {
  ...
  Future<void> _handleRefresh() async {
    final newData = _apiService.getSubjects();
    setState(() {
      _subjectsFuture = newData;
    });
    await newData;
  }
                    ...
                    child: RefreshIndicator(
                      ...
                      child: FutureBuilder<List<dynamic>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          if (!snapshot.hasData || snapshot.data!.isEmpty) return const Center(child: Text('Chưa có môn học nào.'));
...
// --- WIDGET CARD: ĐÃ CHỈNH SỬA THEO YÊU CẦU ---
                  ...
                  child: Stack(
                    children: [
                      Column(
                        ...
                        children: [
                          // 1. Ảnh (Dùng Expanded để chiếm phần lớn không gian)
                          Expanded(
                            child: Stack(
                              fit: StackFit.expand,
                              children: [
                          ...
                          // 2. Thông tin (Dùng Padding + Column với MainAxisSize.min để tự co lại)
                          Padding(
                            padding: const EdgeInsets.fromLTRB(8.0, 8.0, 8.0, 12.0),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              mainAxisSize: MainAxisSize.min, // <--- QUAN TRỌNG: Để phần này tự co lại theo nội dung
                              children: [
                                Text(
                                  widget.subject.name,
